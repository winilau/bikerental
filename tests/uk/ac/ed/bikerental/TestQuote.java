...
public class TestQuote{
	...
	private Bike bike1,bike2,bike3,bike4,bike5,bike6,bike7,
					bike8,bike9,bike10,bike11,bike12,bike13,bike14,bike15;
    ...
    void setUp() throws Exception {
        ...
        Rachel = new Provider("Rachel Green", lo1, "07136086345", BigDecimal(14));
        Ross = new Provider("Ross Geller", lo2, "07365823912", BigDecimal(11.25));
        Monica = new Provider("Monica Geller", lo3, "07394619363", BigDecimal(10.50));
        Joey = new Provider("Joey Tribbiani", lo4, "07019368294", BigDecimal(13.75));
        Phobee = new Provider("Phobee Buffay",lo5,"07527307123",BigDecimal(12.25));
        ...
        this.bike11 = new Bike(cyclocross,true, Ross);
    ...
    void testgetQuote1(){
      ...
      Quote q = new Quote(Rachel,bikes,dateRange1, BigDecimal(272).stripTrailingZeros(),BigDecimal(11900).stripTrailingZeros());
      results.add(q);
